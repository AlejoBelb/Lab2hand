// server/src/controllers/global.controller.js
// Controladores de gestión global (instituciones y usuarios) — exclusivo para ADMIN.
...
async function getGlobalUsers(req, res, next) {
  try {
...
async function postGlobalUser(req, res, next) {
  try {
...
async function patchGlobalUser(req, res, next) {
  try {
