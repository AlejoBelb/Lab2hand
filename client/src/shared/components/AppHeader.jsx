        ...
        <div className="ah-bar">
          ...
          {!isAuthenticated && (
            <button className="ah-login-btn" onClick={() => navigate("/login")}>
              <svg className="ah-dd-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
          ...
          {isAuthenticated && (
            <div className="ah-user-wrap" ref={menuRef}>
              ...
              >
                {/* Ícono de usuario (solo decorativo, no editable) */}
                ...
                {/* Chevron */}
                <svg className={`ah-chevron ${menuOpen ? "open" : ""}`} width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
                  <polyline points="6 9 12 15 18 9"/>
                </svg>
              </button>

              {/* Dropdown */}
              <div className={`ah-dropdown ${menuOpen ? "open" : ""}`} role="menu">
                ...
                <div className="ah-dd-section">
                  <button className="ah-dd-item" role="menuitem" onClick={() => { setMenuOpen(false); navigate("/"); }}>
                    <svg className="ah-dd-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                  ...
                  {/* Solo ADMIN */}
                  {user?.role === "ADMIN" && (
                    <button className="ah-dd-item" role="menuitem" onClick={() => { setMenuOpen(false); navigate("/admin/users"); }}>
                      <svg className="ah-dd-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                  ...
                  {/* Solo TEACHER */}
                  {user?.role === "TEACHER" && (
                    <button className="ah-dd-item" role="menuitem" onClick={() => { setMenuOpen(false); navigate("/teacher/guides"); }}>
                      <svg className="ah-dd-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                ...
                {/* Cerrar sesión */}
                <div className="ah-dd-section">
                  <button className="ah-dd-item danger" role="menuitem" onClick={handleLogout}>
                    <svg className="ah-dd-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
